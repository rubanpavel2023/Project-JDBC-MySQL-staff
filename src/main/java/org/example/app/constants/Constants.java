...
public class Constants {
    ...
    public static final String SAME_NAME_ENTERED_MSG = "No changes found. No database update required";
    public static final String INCORRECT_VALUE_MSG = " Incorrect value !";
    //public static final String ALPHANUMERIC_VALUES_ONLY_MSG = "Only alphanumeric values are allowed !";
    ...
    public static final String NAME_COMPANY = "[a-zA-Z0-9]+";
